...
host_base = '10.197.17.39'
def get_vllm_model_id(host: str = host_base, port: int = 8000, api_key: str = "token-123") -> str:
...
class VllmClient:
    ...
    def __init__(self, model: str, host: str = host_base, port: int = 8000, api_key: str = 'token-123'):
        super().__init__()
        self.model = model
